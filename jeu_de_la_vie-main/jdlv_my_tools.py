...
def make_serpent (grid, i, j, color):
    try:
       ...
       # cases [i + 27] [j + 6] ['c'] = color
        ...
        pass
    return grid
#def mine(grid, i, j, color):
   # try:
     #   cases = grid.cases
      #  cases [i] [j+53] ['s'] = life_status
      #  cases [i] [j+53] ['c'] = color5
   # except:
       # pass
   # return grid
